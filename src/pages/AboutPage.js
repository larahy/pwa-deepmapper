            ...
            <Fragment>
                ...
                <section className="section">
                    <div className="container about-copy">
                        <h2 className="subtitle">Deepmapper is a podcast platform with a difference. Our podcasts are short (only a few minutes each) and place-specific (each one has GPS coordinates attached to it). We call them “placecasts”.</h2>
